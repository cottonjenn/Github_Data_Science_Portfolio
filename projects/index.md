...
### [Golf Analytics Research](golf.md)
**Description**: In this project, I’m developing a spatial model that predicts—with uncertainty—how many strokes a professional golfer needs to hole out from any location on the hole, using 1,764 real shots from 139 players on Hole 1 of the 2023 Players Championship at TPC Sawgrass.
...
### [NBA Scouting Report: Data Collection Project](data-acquisition.md)
...
### [NFL Big Data Bowl 2025 Prediction Competition](nfl.md)
...
### [Final Project: Baseball Performance vs Salary](final-project.qmd)
